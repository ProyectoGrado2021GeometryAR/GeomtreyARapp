...
public class LoginTeacher : MonoBehaviour
{
    ...
    //methodo utilizado para validad que los campos del formulario para el inicio de sesión no esten vacios y enviar a la clase Teacher en el modelo los parametros de busqueda
